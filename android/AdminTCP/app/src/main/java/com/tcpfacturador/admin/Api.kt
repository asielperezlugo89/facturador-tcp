...
data class RespId(val ok: Boolean, val tcp_id: Int? = null, val cliente_id: Int? = null, val error: String? = null)
...
data class RespOk(val ok: Boolean, val mensaje: String? = null, val error: String? = null)
